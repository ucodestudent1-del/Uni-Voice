...
export class SubscriptionRepository {
  ...
  async upsertFeatureFlag(input: { code: string; name: string; description?: string | null; category?: string; isPremium?: boolean; requiresPlan?: PlanCode; metadata?: Record<string, unknown> }): Promise<FeatureFlag | null> {
    const res = await query(
       `INSERT INTO feature_flags (code, name, description, category, is_premium, requires_plan, metadata)
