...
import { CurrencyCode, getCurrencyMetadata } from "../domain/value-objects/currency.js";
...
export class Money {
  ...
  static fromDecimal(amount: DecimalValue, currency: CurrencyCode): Money {
    ...
    const d = toDecimal(amount).toDecimalPlaces(meta.decimalPlaces, Decimal.ROUND_HALF_UP);
...
export function moneyFromDecimal(amount: DecimalValue, currency: CurrencyCode): Money {
